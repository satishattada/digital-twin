...
import { HeatmapZoneData, Persona } from "../types";
...
const mockEquipmentData: Equipment[] = [
    ...
    // HVAC Systems
    {
        ...
        alerts: [
            "Compressor failure - temperature rising",
    ...
    },
    {
        ...
        nextMaintenance: "2024-04-28",
        alerts: [
            "Fuel leak detected - immediate shutdown required",
            "Display flicker detected",
        ],
        category: "fuel",
        criticality: "T1",
    },
    ...
    },
    {
        ...
        nextMaintenance: "2024-08-01",
        alerts: [
            "Charging cable wear detected",
            "Circuit breaker tripped - unit offline",
        ],
        category: "ev-charging",
        criticality: "T2",
    },
...
export const FacilitiesManagerDashboard: React.FC<
    FacilitiesManagerDashboardProps
> = ({
    selectedStore,
    selectedCategory,
    ...
    const [selectedEquipment, setSelectedEquipment] = useAtom(
        selectedEquipmentAtom,
    );
    const [equipmentData, setEquipmentData] = useAtom(equipmentDataAtom);
    const [isLoading, setIsLoading] = useAtom(isLoadingAtom);
    const [selectedAssetCategory, setSelectedAssetCategory] = useAtom(
        selectedAssetCategoryAtom,
    );
    const [viewMode, setViewMode] = useAtom(viewModeAtom);
    const [visibleAssetTypes, setVisibleAssetTypes] = useAtom(
        visibleAssetTypesAtom,
    );
    const [isChatOpen, setIsChatOpen] = useAtom(isChatOpenAtom);
    const [dashboardView, setDashboardView] = useState<
        "facility" | "energy" | "case-management"
    >("facility");
    ...
    const getFilteredAssets = () => {
        ...
        if (statusModalFilter.type === "status") {
            return equipmentData.filter(
                (eq) => eq.status === statusModalFilter.value,
            );
                ...
                <div className="flex items-center justify-between bg-white rounded-lg shadow-sm border p-3">
                    <div className="flex gap-2">
                        ...
                        <>
                            ...
                            <button
                                onClick={() =>
                                    setDashboardView("case-management")
                                }
                                className={`px-6 py-3 rounded-lg text-sm font-semibold transition-all flex items-center gap-2 ${
            ...
            {dashboardView === "case-management" && (
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  Cortix Insights Platform
                    ...
                    <div
                        className="relative bg-gradient-to-br from-gray-50 to-gray-100 p-8"
                        ...
                        <div
                            onClick={() =>
                                setStatusModalFilter({
                                    type: "maintenance",
                                    value: "due",
                                    label: "Maintenance Due (Next 30 Days)",
                                })
                            }
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-purple-600">
                                        {complianceCounts.maintenanceChecks}
                                    </p>
                                </div>
                                <span className="text-4xl">🔧</span>
                            </div>
                            ...
                            <div className="space-y-3 mb-4">
                                ...
                                <div className="flex items-center gap-2 flex-wrap bg-gray-50 p-2 rounded-lg border border-gray-200">
                                    ...
                                    {[
                                        ...
                                        {
                                            key: "food-service",
                                            label: "🍽️ Food Service",
                                            color: "pink",
                                        },
                                        {
                                            key: "refrigeration",
                                            label: "❄️ Refrigeration",
                                            color: "cyan",
                                        },
                                        {
                                            key: "car-wash",
                                        ...
                                        const isVisible = visibleAssetTypes.has(
                                            category.key,
                                        );
                                        return (
                                            <button
                                ...
                                <RetailFacilityLayout
                                    ...
                                    onAssetClick={(asset) => {
                                        ...
                                        if (matchingEquipment) {
                                            ...
                                            console.log(
                                                `No equipment found for asset: ${asset.id} (${asset.name})`,
                                            );
                                        }
                                    }}
                            ...
                            <div className="bg-white rounded-lg shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
                                ...
                                <div className="p-6 border-b border-gray-200">
                                    ...
                                    <p className="text-sm text-gray-600 mt-2">
                                        Total: {getFilteredAssets().length}{" "}
                                        asset
                                        {getFilteredAssets().length !== 1
                                            ? "s"
                                            : ""}
                                    </p>
                                </div>
                                                ...
                                                (asset) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center gap-2 flex-wrap mt-2">
                                                            <span
                                                                className={`text-xs px-2 py-1 rounded-md border ${getStatusColor(asset.status)}`}
                                                            >
                                                                {asset.status}
                                                            </span>
                                                            {asset.category && (
...
export const FacilitiesManagerDashboardWrapper: React.FC<
    FacilitiesManagerDashboardProps
> = (props) => {
    ...
    return (
        <FacilitiesManagerDashboard
            {...props}
            onNavigateToAssetDetails={() => setShowAssetDetailsPage(true)}
        />
    );
};
