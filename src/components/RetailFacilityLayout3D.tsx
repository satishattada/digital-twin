...
const RetailFacilityLayout3D: React.FC<{
        ...
        if (asset.type === "building") {
            return {
                ...
                transform: isSelected
                    ? "rotateX(60deg) rotateZ(-45deg) scale(1.05)"
            ...
            switch (asset.category) {
                case "car-wash":
                    transformStyle =
                        "rotateX(0deg) rotateY(0deg) rotateZ(-7deg) translateZ(0px)";
                    break;
                case "service":
                    transformStyle =
                        "rotateX(28deg) rotateY(40deg) rotateZ(-2deg) translateZ(25px)";
                    break;
                case "refrigeration":
                    transformStyle =
                        "rotateX(10deg) rotateY(30deg) rotateZ(-10deg) translateZ(25px)";
                    break;
                case "food-service":
                    transformStyle =
                        "rotateX(0deg) rotateY(0deg) rotateZ(0deg) translateZ(25px)";
                    break;
                case "energy":
                ...
                default:
                    transformStyle =
                        "rotateX(9deg) rotateY(5deg) rotateZ(4deg) translateZ(25px)";
                    break;
            }
            ...
            if (status === "critical") {
                filterStyle =
                    "drop-shadow(0 0 20px rgba(220, 38, 38, 0.9)) drop-shadow(0 0 10px rgba(220, 38, 38, 0.6)) brightness(1.3)";
                textShadow =
                    "0 0 12px rgba(220, 38, 38, 1), 0 0 6px rgba(220, 38, 38, 0.8)";
                animation = "pulse-red 1.5s ease-in-out infinite";
            } else if (status === "warning") {
                filterStyle =
                    "drop-shadow(0 0 15px rgba(234, 179, 8, 0.8)) drop-shadow(0 0 8px rgba(234, 179, 8, 0.5)) brightness(1.2)";
                textShadow =
                    "0 0 10px rgba(234, 179, 8, 1), 0 0 5px rgba(234, 179, 8, 0.7)";
                animation = "pulse-yellow 2s ease-in-out infinite";
            } else if (status === "offline") {
                filterStyle =
                    "drop-shadow(0 6px 12px rgba(0,0,0,0.5)) grayscale(80%) brightness(0.6)";
            ...
            <span className="text-sm font-bold text-slate-800 drop-shadow-sm">{asset.name}</span>
                ...
                <div
                    ...
                    style={{
                        ...
                        width: "100%",
                        height: `${visualDepth}px`,
                        background: isSelected ? "#1d4ed8" : "#64748b",
                ...
                {[0, 25, 50, 75, 100].map((pos, idx) => (
                    <div
                        ...
                        style={{
                            ...
                            boxShadow:
                                "2px 2px 6px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.2)",
                            filter: "brightness(0.8)",
                        }}
                    />
                ))}
    ...
    return (
        ...
        >
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                ...
                                borderRadius: "8px",
                                boxShadow:
                                    "0 4px 12px rgba(16, 185, 129, 0.5), inset 0 2px 4px rgba(255,255,255,0.3)",
                                fontSize: "24px",
                                color: "white",
                                fontWeight: "bold",
                                cursor: "pointer",
                        ...
                        <div
                            ...
                            style={{
                                ...
                                borderRadius: "8px",
                                boxShadow:
                                    "0 4px 12px rgba(239, 68, 68, 0.5), inset 0 2px 4px rgba(255,255,255,0.3)",
                                fontSize: "24px",
                                color: "white",
                                fontWeight: "bold",
                                cursor: "pointer",
                        ...
                        <div
                            ...
                            style={{
                                ...
                                borderRadius: "8px",
                                boxShadow:
                                    "0 4px 12px rgba(59, 130, 246, 0.5), inset 0 2px 4px rgba(255,255,255,0.3)",
                                fontSize: "20px",
                                color: "white",
                                fontWeight: "bold",
                                cursor: "pointer",
            ...
            {persona !== "Digital Engineer" && !showLegend && (
                <button
