...
export const PlanogramTracker: React.FC<PlanogramTrackerProps> = ({ selectedCategory }) => {
  ...
  return (
    <div className="flex-grow flex flex-col h-full">
      <h2 className="text-lg font-bold text-[#005BAC] mb-2 shrink-0">Planogram Compliance Tracker</h2>
      ...
      <div className="flex-grow grid grid-cols-2 gap-4 min-h-0">
        <div className="flex flex-col">
          <h3 className="text-md font-semibold text-gray-800 mb-2 text-center">Current View</h3>
          <PlanogramView data={data.current} />
        </div>
        <div className="flex flex-col">
           <h3 className="text-md font-semibold text-gray-800 mb-2 text-center">AI Optimized Planogram</h3>
