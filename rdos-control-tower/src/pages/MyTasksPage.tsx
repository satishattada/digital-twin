...
type TaskType = 'Approval' | 'Review' | 'Data Fix';
...
const ASSET_TASKS: AssetTask[] = [
  {
    id: 'TSK-401',
    title: 'Approve HVAC refurbishment for UK-HVAC-001',
    type: 'Approval',
    status: 'Due Today',
    dueDate: '2026-02-21',
    assignedBy: 'rDOS Strategy Agent',
    relatedEntity: 'UK-HVAC-001',
    needsContext: false
  },
  {
    id: 'TSK-402',
    title: 'Review telemetry anomaly for APAC-ELEV-003',
    type: 'Review',
    status: 'Due Today',
    dueDate: '2026-02-21',
    assignedBy: 'Asset Performance Monitor',
    relatedEntity: 'APAC-ELEV-003',
    needsContext: true
  },
  {
    id: 'TSK-403',
    title: 'Fix missing maintenance records for EU-COOL-002',
    type: 'Data Fix',
    status: 'Over SLA',
    dueDate: '2026-02-20',
    assignedBy: 'rDOS Data Quality Monitor',
    relatedEntity: 'EU-COOL-002',
    needsContext: false
  },
  ...SAMPLE_TASKS.map(t => ({
    id: t.id,
...
export const MyTasksPage: React.FC = () => {
  ...
  let filteredTasks = filterStatus === 'All'
    ? ASSET_TASKS
    : ASSET_TASKS.filter(task => task.status === filterStatus);
      ...
      <div className="bg-gradient-to-r from-green-900 to-green-700 text-white p-6 md:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-green-100 text-xs">
            Track approvals, reviews, and data quality fixes for asset lifecycle decisions
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
            <div>
              ...
              <p className="text-gray-600">Approvals • Reviews • Data Fixes • Claims • Mentions</p>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6">
          <div className="bg-gradient-to-br from-orange-50 to-white border border-orange-200 rounded-lg shadow-sm p-6">
            ...
            <div className="text-3xl font-bold text-orange-700">
              {ASSET_TASKS.filter(t => t.status === 'Due Today').length}
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-white border border-purple-200 rounded-lg shadow-sm p-6">
            ...
            <div className="text-3xl font-bold text-purple-700">
              {ASSET_TASKS.filter(t => t.needsContext).length}
            </div>
          </div>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 text-sm text-gray-900">Review lifecycle extension for UK-COOL-004</td>
                  <td className="px-6 py-4 text-sm">
                    <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs font-medium">Review</span>
                  </td>
                  <td className="px-6 py-4 text-sm text-gray-700">Engineering Team</td>
                  <td className="px-6 py-4 text-sm">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 text-sm text-gray-900">Approve replacement decision for APAC-HVAC-002</td>
                  <td className="px-6 py-4 text-sm">
                    <span className="px-2 py-1 bg-purple-100 text-purple-800 rounded text-xs font-medium">Approval</span>
                  </td>
                  <td className="px-6 py-4 text-sm text-gray-700">Asset Manager</td>
                  <td className="px-6 py-4 text-sm">
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="text-sm text-gray-900">Completed <span className="font-medium">HVAC refurbishment approval for UK-HVAC-003</span></div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                <div className="flex-1">
                  <div className="text-sm text-gray-900">Opened <span className="font-medium">Performance anomaly review for APAC-ELEV-001</span></div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="text-sm text-gray-900">Mentioned in <span className="font-medium">Budget allocation discussion for EU assets</span></div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="text-sm text-gray-900">Assigned <span className="font-medium">Telemetry gap fix to Data Quality Team</span></div>
