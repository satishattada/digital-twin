...
export const MOCK_STORE_LAYOUT_DATA: HeatmapZoneData[] = [
    ...
    { id: 'zone11', name: 'ENTRY', engagement: 'low', gridClass: 'col-span-2 row-span-1 font-bold', insights: { topSku: 'N/A', lowPerformer: 'N/A', layoutSuggestion: 'N/A', aiRationale: 'N/A' } },
    { id: 'zone12', name: 'Household', engagement: 'low', gridClass: 'col-span-5 row-span-1', insights: { topSku: 'Paper Towels - 60 units/wk', lowPerformer: 'Air Freshener - 8 units/wk', layoutSuggestion: 'Place cleaning wipes near high-traffic areas.', aiRationale: 'Encourages impulse purchase for convenience.' } },
    { id: 'zone13', name: 'POS', engagement: 'low', gridClass: 'col-span-3 row-span-1', insights: { topSku: 'N/A', lowPerformer: 'N/A', layoutSuggestion: 'N/A', aiRationale: 'N/A' } },
